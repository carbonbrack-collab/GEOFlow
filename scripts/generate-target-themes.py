...
def build(k, spec):
    ...
    css = [
        ...
        # 面包屑、分页、相关文章
        f'.target-theme-{k} .crumbs,.target-theme-{k} .crumbs a{{color:{muted}}}',
        f'.target-theme-{k} .crumbs a:hover{{color:{accent}}}',
        f'.target-theme-{k} .crumbs-sep{{color:{line}}}',
        f'.target-theme-{k} .pager-link{{color:{accent}}}',
        f'.target-theme-{k} .pager-status{{color:{muted}}}',
        f'.target-theme-{k} .related-title{{font-family:{fhead};color:{ink}}}',
        f'.target-theme-{k} .related-card{{background:{surface};border:1px solid {line};border-radius:{radius}px}}',
        f'.target-theme-{k} .related-card:hover{{border-color:{accent}}}',
        f'.target-theme-{k} .related-card-title{{color:{ink}}}',
        f'.target-theme-{k} .related-card-summary{{color:{muted}}}',
