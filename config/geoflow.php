...
$defaultUpdateMetadataUrl = 'https://raw.githubusercontent.com/carbonbrack-collab/GEOFlow/main/version.json';
...
return [
    ...
    'update_allowed_repository' => trim((string) env('GEOFLOW_UPDATE_ALLOWED_REPOSITORY', 'https://github.com/carbonbrack-collab/GEOFlow'), '/'),
